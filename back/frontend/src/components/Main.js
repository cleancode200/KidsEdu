            ...
            <div className="row fullscreen d-flex align-items-center justify-content-center">
              <div className="banner-content col-lg-8 col-md-12">
                ...
                <p className="text-white">
                  We aim to teach our childs by letting them play, without
          ...
          <div className="container">
            <div className="row align-items-center justify-content-center">
              <div className="col-lg-5 col-md-6 about-left">
                <img
                  className="img-fluid"
                  src="homepageTemplete/img/about.jpg"
                  alt=""
                />
              </div>
              <div className="offset-lg-1 col-lg-6 offset-md-0 col-md-12 about-right">
                ...
                <div className="wow fadeIn" data-wow-duration="1s">
                  <p>[fill this paragraph long one]</p>
                </div>
              </div>
            </div>
          </div>
              ...
              <div className="col-lg-5 about-right">
                ...
                <div className="wow fadeIn" data-wow-duration="1s">
                  <p>
                    ...
                    to think about setting up your own viewing station. In the
                    life of any aspiring astronomer that it is time to buy that
                    first telescope. It’s exciting to think about setting up
                    your own viewing station.
                  </p>
                </div>
                <a href="courses.html" className="primary-btn white">
                  Explore Courses
                </a>
              </div>
            ...
            <div className="row justify-content-center d-flex align-items-center">
              <div className="col-lg-3 col-md-6 col-sm-12 single-faculty">
                <div className="thumb d-flex justify-content-center">
                  <img
                    className="img-fluid"
                    src="homepageTemplete/img/faculty/f1.jpg"
                    alt=""
                  />
                </div>
                <div className="meta-text text-center">
                  ...
                  <div
                    className="info wow fadeIn"
                    data-wow-duration="1s"
                    data-wow-delay=".1s"
                  >
                    <p>
                      If you are looking at blank cassettes on the web, you may
                      be very confused at the difference in price.
                    </p>
                  </div>
              ...
              <div className="col-lg-3 col-md-6 col-sm-12 single-faculty">
                <div className="thumb d-flex justify-content-center">
                  <img
                    className="img-fluid"
                    src="homepageTemplete/img/faculty/f2.jpg"
                    alt=""
                  />
                </div>
                <div className="meta-text text-center">
              ...
              <div className="col-lg-3 col-md-6 col-sm-12 single-faculty">
                <div className="thumb d-flex justify-content-center">
                  <img
                    className="img-fluid"
                    src="homepageTemplete/img/faculty/f3.jpg"
                    alt=""
                  />
                </div>
                <div className="meta-text text-center">
              ...
              <div className="col-lg-3 col-md-6 col-sm-12 single-faculty">
                <div className="thumb d-flex justify-content-center">
                  <img
                    className="img-fluid"
                    src="homepageTemplete/img/faculty/f4.jpg"
                    alt=""
                  />
                </div>
                <div className="meta-text text-center">
